var TgTableSort = window.TgTableSort ||
    function(n, t) {
        "use strict";
        ...
        function i(n) { return n.innerHTML || "" }
        ...
        function m(n, t, r) {
            var e = u(n, t),
                o = e.map(function(n, t) { return{ str: n, index: t } }),
        ...
        function p(n, t, r, o) {
            for (var i = f(o, E) ? N : T, u = m(n, r, i), c = 0; t > c; ++c) {
                var s = e(n, c), d = a(n, c);
                s.forEach(function(n, t) { n.innerHTML = d[u[t]] })
            }
            l(n, o, i)
        }
        ...
        function x(n, t) {
            ...
            t.forEach(function(t, e) {
                t.addEventListener("click", function() { p(n, r, e, t) }), s(t, "tg-sort-header")
            })
        }
...
document.addEventListener("DOMContentLoaded", function(n) { TgTableSort("tg-mcNMp") });